...
public class RefreshListView extends ListView {
    ...
    private boolean isSwipeToLoadMoreEnable;
...
//                        System.out.println("scrollY:" + scrollY);
    ...
    private boolean isLunboFullShow() {
        ...
        //如果lunbotu为空，或者不能下拉刷新就直接返回
        if (lunbotu == null || !isPullToRefreshEnable) {
            return true;
        }
...
// 也可以        headerContainer.setPadding(0, -ll_refresh_header_root_height, 0, 0);
     ...
     * @param b 是否允许下拉刷新
     */
    public void setPullToRefreshEnable(boolean b) {
        this.isPullToRefreshEnable = b;
    }

    /**
     * @param b 是否允许上滑加载更多
     */
    public void setSwipeToLoadMoreEnable(boolean b) {
        this.isSwipeToLoadMoreEnable = b;
    }
